...
function Theme() {
  ...
  return (
    <div className='w-full flex justify-between items-center'>
       {theme === "dark" && (<div className='text-md p-2'>Light mode</div>)}
       {theme === "light" && (<div className='text-md p-2'>Dark mode</div>)}
         
        <div className="flex-none">
            <ul className="menu menu-horizontal px-1">
            <label className="swap swap-rotate">
                <input type="checkbox" className="theme-controller" value={"synthwave"} onChange={handleToggle}  defaultChecked={theme === "dark"} /> 
